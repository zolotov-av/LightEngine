...
/*****************************************************************************
  ...
  Пример конфигурационного файла system.php
...
if ( $session = $engine->session->getSessionInfo() )
{
	...
	$engine->tpl->set_tag('access', array(
	...
	$engine->tpl->set_tag('sidebar_blocks', $engine->swm->getSidebarBlocksValues());
}
*/