<script type="text/javascript">
	function form_submit(form) {form.onsubmit}
</script>
<form action="{escape(form.url)}" method="post" onsubmit="return form_submit(this);" enctype="multipart/form-data">
 <table class="gc_table" width="100%">
  {if form.title}
  <tr>
   <th colspan="2"><h3>{escape(form.title)}</h3></th>
  </tr>
  {endif}
